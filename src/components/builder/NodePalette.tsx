    ...
    <aside className="w-[300px] h-full bg-[#0d0d12] border-r border-white/5 flex flex-col overflow-hidden relative z-20">
      ...
      <div className="p-6 space-y-5 relative">
        <div className="flex items-center justify-between">
          <h2 className="text-[11px] font-black text-white uppercase tracking-[0.3em]">Node Library</h2>
                  ...
                  >
                    ...
                    <div className="relative p-4 rounded-xl bg-white/[0.03] border border-white/5 group-hover:border-white/20 group-hover:bg-white/[0.06] cursor-grab active:cursor-grabbing transition-all duration-300">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-sm font-bold text-white group-hover:text-white transition-colors tracking-tight italic">
                          {node.label}
                        </span>
                      ...
                      <p className="text-[10px] text-white/40 group-hover:text-white/60 transition-colors font-medium">
                        {node.description}
                      </p>
                    </div>
                  </div>
