        ...
        >
          ...
          <div className="px-8 py-6 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white font-syne">Strategy Optimizer</h3>
                <p className="text-xs text-white/40 uppercase tracking-widest font-black">Historical Performance Analysis</p>
              </div>
            </div>
            <button 
              onClick={onClose}
            ...
            <div className="w-[340px] border-r border-white/5 p-8 space-y-8 bg-black/40">
              <div className="space-y-6">
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-white/30 uppercase tracking-widest">Simulation Symbol</label>
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-white/30 uppercase tracking-widest">Simulation Range</label>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="h-11 bg-white/5 border border-white/10 rounded-xl px-4 flex items-center text-[10px] text-white/60">2024-01-01</div>
                    <div className="h-11 bg-white/5 border border-white/10 rounded-xl px-4 flex items-center text-[10px] text-white/60">Today</div>
                  </div>
                </div>
              </div>
              ...
              <Button 
                ...
                className="w-full h-14 bg-gradient-to-r from-amber-600 to-amber-500 text-white font-black text-xs uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-amber-600/20 group"
              >
                {isBacktesting ? (
            ...
            <div className="flex-1 p-8 bg-black/20 overflow-y-auto">
              {!isBacktesting && !showResults ? (
                <div className="h-full flex flex-col items-center justify-center space-y-6 opacity-20">
                  ...
                  <p className="text-xl font-syne font-bold">Ready to analyze performance...</p>
                </div>
              ) : isBacktesting ? (
                ...
                <div className="grid grid-cols-12 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  ...
                  <div className="col-span-8 h-[240px] bg-white/5 border border-white/5 rounded-3xl p-6 relative">
                    <p className="text-[10px] font-black text-white/30 uppercase tracking-widest absolute top-6 left-6 z-10">Equity Curve Simulation</p>
