    ...
    <div className="w-80 border-r border-white/5 bg-[#0d0d12]/50 backdrop-blur-3xl flex flex-col shrink-0 relative z-20">
      <div className="p-8 space-y-8">
        <div className="space-y-2">
          <h3 className="text-sm font-black text-white uppercase tracking-[0.3em]">Library</h3>
          <p className="text-[10px] text-white/30 font-bold uppercase tracking-widest">Select logic modules</p>
        </div>
        ...
        <div className="relative group">
          ...
          <input 
            ...
            className="w-full h-11 bg-white/5 border border-white/5 rounded-2xl pl-10 pr-4 text-[10px] font-black tracking-widest text-white placeholder:text-white/10 outline-none focus:border-p/30 transition-all"
          />
        </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] text-white/20 font-bold uppercase tracking-tighter mt-0.5">{node.description}</span>
              </div>
            </div>
          </div>
        ))}
      ...
      <div className="p-6 bg-gradient-to-t from-black/40 to-transparent">
        <div className="p-4 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 flex items-center gap-4 group cursor-pointer hover:bg-indigo-500/10 transition-all">
          ...
          <div>
            <h4 className="text-[10px] font-black text-white uppercase tracking-widest leading-none">Smart Template</h4>
            <p className="text-[9px] text-indigo-400/60 font-medium mt-1">Load EMA Cross Logic</p>
          </div>
        </div>
      </div>
    </div>
