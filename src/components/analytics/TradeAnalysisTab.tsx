            ...
            <Card className="p-12 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group rounded-[48px]">
                ...
                <div className="space-y-4 mb-16 relative z-10">
                    <div className="flex items-center gap-5">
                        ...
                        <h4 className="text-2xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Outcome_Lattice_Dist</h4>
                    </div>
                    <p className="text-[11px] text-white/30 font-black uppercase tracking-[0.4em] leading-relaxed italic font-syne">Trade frequency mapped across institutional P&L corridors.</p>
                </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={pnlDist} margin={{ top: 20, right: 30, left: 0, bottom: 20 }}>
                            ...
                            <Tooltip 
                                ...
                                itemStyle={{ color: '#fff', fontSize: '14px', fontWeight: '900', fontStyle: 'italic', fontFamily: 'Syne' }}
            ...
            <Card className="p-12 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] flex flex-col items-center justify-center relative overflow-hidden rounded-[48px] group/core">
                ...
                <div className="absolute top-12 left-12 space-y-4 relative z-20 w-full">
                    <div className="flex items-center gap-5">
                        ...
                        <h4 className="text-2xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Execution_Core_Efficiency</h4>
                    </div>
                    <p className="text-[11px] text-white/30 font-black uppercase tracking-[0.4em] leading-relaxed italic font-syne">Real-time volume-weighted win/loss kernel telemetry.</p>
                </div>
                ...
                <div className="h-[420px] w-full relative mt-12 group/donut">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        ...
                        >
                           <span className="text-8xl font-black text-white font-syne italic tracking-tighter leading-none shadow-[0_0_20px_rgba(255,255,255,0.2)]">72<span className="text-3xl text-white/30 ml-1">%</span></span>
                           <span className="text-[12px] font-black text-white/20 uppercase tracking-[0.6em] mt-6 font-syne italic">CORE_WIN_RATIO</span>
                           <div className="mt-8 flex flex-col items-center">
                               ...
                               <div className="px-5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                                   <span className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] font-syne italic">ALPHA_OPTIMIZED_STATE</span>
                               </div>
                           </div>
                        </motion.div>
                    </div>
                ...
                <div className="flex justify-center gap-20 mt-10 relative z-20 w-full px-12">
                    <div className="flex flex-col items-center gap-4 group/win">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-4xl font-black text-white font-syne italic tracking-tighter">185</span>
                        </div>
                        <span className="text-[11px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">INSTITUTIONAL_WINS</span>
                    </div>
                    <div className="flex flex-col items-center gap-4 group/loss">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-4xl font-black text-white font-syne italic tracking-tighter">72</span>
                        </div>
                        <span className="text-[11px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">MARKET_FRICTION</span>
                    </div>
                </div>
            </Card>
          </motion.div>
            ...
            <Card className="p-12 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] h-full relative overflow-hidden group rounded-[48px]">
                ...
                <div className="space-y-4 mb-16 relative z-10">
                    <div className="flex items-center gap-5">
                        ...
                        <h4 className="text-2xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Asset_Alpha_Kernel</h4>
                    </div>
                    <p className="text-[11px] text-white/30 font-black uppercase tracking-[0.4em] leading-relaxed italic font-syne italic">Recursive attribution matrix by primary instrument class.</p>
                </div>
                        ...
                        <div key={item.symbol} className="space-y-4 group/item">
                            <div className="flex items-end justify-between px-2">
                                <div className="flex flex-col gap-1">
                                    <span className="text-lg font-black text-white tracking-widest uppercase group-hover/item:text-cyan-400 transition-all font-syne italic leading-none">{item.symbol}</span>
                                    <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] font-syne italic">{item.trades}_EXECUTIONS_SYNCED</span>
                                </div>
                                <div className="flex flex-col items-end gap-1">
                                   <span className={cn("text-2xl font-black font-syne italic tracking-tighter leading-none shadow-sm", item.pnl > 0 ? "text-emerald-400" : "text-red-400")}>
            ...
            <Card className="p-12 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative overflow-hidden rounded-[48px] group/temp">
                ...
                <div className="space-y-4 mb-20 relative z-10">
                    <div className="flex items-center gap-5">
                        ...
                        <h4 className="text-2xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Temporal_Holding_Profile</h4>
                    </div>
                    <p className="text-[11px] text-white/30 font-black uppercase tracking-[0.4em] leading-relaxed italic font-syne">Heuristic holding period density distribution by epoch.</p>
                </div>
                ...
                <div className="mt-14 flex items-center justify-between border-t-2 border-white/5 pt-10 relative z-10">
                    <div className="flex items-center gap-4 group/l1">
                        ...
                        <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] font-syne italic">EPOCH_SCALP</span>
                    </div>
                    <div className="flex items-center gap-4 group/l2">
                        ...
                        <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] font-syne italic">INTRADAY_LENS</span>
                    </div>
                    <div className="flex items-center gap-4 group/l3">
                        ...
                        <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] font-syne italic">LONG_EPOCH_SWING</span>
                    </div>
                </div>
            </Card>
          </motion.div>
