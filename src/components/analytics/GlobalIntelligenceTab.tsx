  ...
  >
    ...
    <div className="absolute top-10 left-12 z-20">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h4 className="text-sm font-black text-white uppercase tracking-[0.5em] font-syne">Global Network Intel</h4>
                <p className="text-[10px] text-white/20 font-bold uppercase tracking-[0.3em] mt-1">Satellite Hub Synchronization Protocol v2.4</p>
            </div>
        </div>
    </div>
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-8 p-6 rounded-[32px] bg-[#08080c]/95 backdrop-blur-3xl border border-white/10 opacity-0 group-hover:opacity-100 transition-all pointer-events-none whitespace-nowrap scale-75 group-hover:scale-100 translate-y-4 group-hover:translate-y-0 transform origin-bottom z-50 shadow-[0_40px_80px_rgba(0,0,0,0.8)] border-p/20">
                    <div className="flex items-center justify-between gap-10 mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-[10px] font-black text-p uppercase tracking-[0.3em] font-syne">{dot.label}</p>
                        </div>
                        <span className="text-[8px] font-black text-white/20 uppercase tracking-widest">{dot.cluster} CLUSTER</span>
                    </div>
                    <p className="text-3xl font-black text-white italic tracking-tighter uppercase font-syne">{dot.city}</p>
                    <div className="h-[1px] w-full bg-gradient-to-r from-white/10 via-white/5 to-transparent my-4" />
                    <div className="flex items-center gap-6">
                        <div className="flex flex-col">
                            <span className="text-[8px] font-black text-white/20 uppercase tracking-widest">Active nodes</span>
                            <span className="text-sm font-black text-white font-jet-mono italic">1,248</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-[8px] font-black text-white/20 uppercase tracking-widest">Latency</span>
                            <span className="text-sm font-black text-emerald-400 font-jet-mono italic">4.2ms</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div className="absolute bottom-10 left-12 right-12 flex items-center justify-between z-20">
        <div className="flex items-center gap-8 bg-black/60 p-4 rounded-[24px] border border-white/5 backdrop-blur-3xl">
            <div className="flex items-center gap-3">
                ...
                <span className="text-[9px] font-black text-white/40 uppercase tracking-[0.2em]">Institutional Core</span>
            </div>
            <div className="w-[1px] h-3 bg-white/10" />
            <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_10px_#10b981]" />
                <span className="text-[9px] font-black text-white/40 uppercase tracking-[0.2em]">HFT Satellite</span>
            </div>
        </div>
        <div className="flex items-center gap-3 bg-p p-4 px-8 rounded-[24px] shadow-2xl shadow-p/20 cursor-pointer hover:bg-indigo-500 transition-all">
             <span className="text-[10px] font-black text-white uppercase tracking-[0.4em]">Initialize Global Sync</span>
            ...
            <Card className="p-[var(--card-p)] border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] space-y-16 h-full relative overflow-hidden group rounded-[40px]">
                ...
                <div className="space-y-3 relative z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h4 className="text-xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Alpha_Regime_Vector</h4>
                    </div>
                    <p className="text-[10px] text-white/30 font-black uppercase tracking-[0.3em] leading-relaxed italic font-syne">Real-time recursive acceleration by algorithmic philosophy index.</p>
                </div>
                        ...
                        <div key={cat.id} className="space-y-4 group/bar">
                            <div className="flex items-center justify-between px-2">
                                <div className="space-y-1.5">
                                    <span className="text-lg font-black text-white uppercase tracking-tighter group-hover/bar:text-p transition-all font-syne italic leading-none">{cat.label}</span>
                                    <p className="text-[9px] font-black text-white/10 uppercase tracking-[0.3em] font-syne italic">{cat.desc}_SYNC</p>
                                </div>
                                <div className={cn("px-4 py-2 rounded-2xl border-2 tabular-nums text-[11px] font-black font-syne italic", cat.trend.startsWith('+') ? 'text-emerald-400 border-emerald-500/10 bg-emerald-500/5 shadow-[0_0_15px_rgba(16,185,129,0.1)]' : 'text-red-400 border-red-500/10 bg-red-500/5')}>
                                    {cat.trend}
                                </div>
                            </div>
                ...
                <div className="pt-16 border-t-2 border-white/5 relative z-10">
                    <div className="p-[var(--card-p)] rounded-[32px] border-2 border-white/10 bg-[#08080c] relative overflow-hidden group shadow-[0_40px_80px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="relative z-10 space-y-10 flex flex-col items-center text-center">
                            <span className="text-[11px] font-black text-p uppercase tracking-[0.6em] font-syne italic">CORE_REGIME_TELEMETRY</span>
                            <div className="p-1.5 px-6 rounded-[28px] bg-white/[0.03] border-2 border-white/5 group-hover:scale-110 transition-transform duration-1000 hover:rotate-2">
                                <h3 className="text-5xl font-black text-white tracking-[0.1em] font-syne italic drop-shadow-[0_15px_20px_rgba(0,0,0,0.8)]">TRENDING</h3>
                            </div>
                            <div className="grid grid-cols-2 gap-12 w-full">
                                <div className="flex flex-col gap-2">
                                    <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] font-syne italic">CONFIDENCE</span>
                                    <span className="text-2xl font-black text-emerald-400 font-syne italic tracking-tighter">94.2%</span>
                                </div>
                                <div className="flex flex-col gap-2">
                                    <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] font-syne italic">BIAS_VECTOR</span>
                                    <span className="text-2xl font-black text-p font-syne italic tracking-tighter">BULLISH</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <Card className="p-[var(--card-p)] border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] h-full group relative overflow-hidden rounded-[40px]">
                        ...
                        <div className="flex items-center justify-between mb-16 relative z-10">
                            <div className="flex items-center gap-5">
                                ...
                                <h4 className="text-xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Intelligence_Hub_Feed</h4>
                            </div>
                            <div className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-emerald-500/10 border-2 border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
                                ...
                                <span className="text-[9px] font-black text-emerald-400 uppercase tracking-[0.4em] font-syne italic">LIVE_SYNC</span>
                            </div>
                        </div>
                            ...
                            {news.map((n, i) => (
                                <div key={i} className="flex gap-10 group/item relative">
                                    <div className="flex flex-col items-center">
                                        <div className="w-20 py-3.5 rounded-2xl bg-white/[0.03] border-2 border-white/5 text-[12px] font-black text-white font-syne italic group-hover/item:border-p/50 group-hover/item:text-p transition-all shadow-2xl text-center">
                                            {n.time}
                                        </div>
                                    ...
                                    <div className="flex-1 space-y-4 pb-4">
                                        <div className="flex items-center justify-between gap-4">
                                            <span className="text-sm font-black text-white uppercase tracking-widest font-syne italic leading-none">{n.event}</span>
                                            <span className={cn("text-[9px] font-black uppercase tracking-[0.4em] px-3 py-1.5 rounded-xl border-2 font-syne italic shrink-0", n.impactColor.split(' ')[1], n.impactColor.split(' ')[0])}>{n.impact}</span>
                                        </div>
                                        <p className="text-[12px] text-white/30 font-black uppercase tracking-[0.3em] leading-relaxed italic font-syne">{n.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                  ...
                  <motion.div variants={itemVariants}>
                    <Card className="p-[var(--card-p)] border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] h-full group relative overflow-hidden rounded-[40px]">
                        ...
                        <div className="flex items-center gap-5 mb-16 relative z-10">
                            ...
                            <h4 className="text-xl font-black text-white uppercase tracking-tighter font-syne italic leading-none">Alpha_Command_Registry</h4>
                        </div>
                                ...
                                <div key={i} className="flex items-center justify-between group/leader p-6 rounded-[36px] hover:bg-white/[0.04] border-2 border-transparent hover:border-white/5 transition-all duration-700">
                                    <div className="flex items-center gap-8">
                                        <div className="relative">
                                            ...
                                            <div className="absolute -top-4 -right-4 w-9 h-9 rounded-xl bg-black border-2 border-white/10 flex items-center justify-center text-[12px] font-black text-white shadow-[0_10px_20px_rgba(0,0,0,0.8)] z-20 group-hover/leader:border-p group-hover/leader:text-p transition-colors font-syne">{t.rank}</div>
                                        </div>
                                        <div className="space-y-2">
                                            <span className="text-sm font-black text-white uppercase tracking-wide group-hover/leader:text-p transition-colors italic font-syne">{t.name}</span>
                                            <div className="flex items-center gap-4">
                                                <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] font-syne italic">{t.strategies}_NODES</span>
                                                <div className="w-1.5 h-1.5 rounded-full bg-white/10" />
                                                <span className="text-[9px] font-black text-p uppercase tracking-[0.3em] font-syne italic">{t.tier}_TIER</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="text-2xl font-black text-emerald-400 font-syne italic tracking-tighter group-hover/leader:scale-125 transition-transform duration-700">{t.return}</span>
                                        <span className="text-[9px] font-black text-white/10 uppercase tracking-[0.2em] font-syne italic">MONTHLY_P&L</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        >
                            <span className="text-[12px] font-black text-white/30 uppercase tracking-[0.5em] font-syne italic group-hover:text-white transition-colors">Open_Explorer_Registry</span>
