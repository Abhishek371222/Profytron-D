  ...
  if (active && payload?.[0]) {
    ...
    return (
      <div className="bg-[#0a0a0f]/95 border-2 border-red-500/20 rounded-[20px] p-5 shadow-[0_30px_60px_rgba(239,68,68,0.2)] backdrop-blur-3xl">
        <p className="text-[9px] font-black text-red-500/40 uppercase tracking-[0.4em] font-syne mb-2">{label}</p>
        <p className="text-xl font-black text-red-500 font-syne italic">{v.toFixed(2)}% <span className="text-[10px] text-white/20 ml-2 font-normal uppercase tracking-wider">drawdown</span></p>
      </div>
    );
  }
  return null;
          ...
          <Card className="p-10 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] flex flex-col items-center h-full relative overflow-hidden group rounded-[40px]">
            ...
            <div className="w-full space-y-3 mb-10 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <h4 className="text-lg font-black text-white uppercase tracking-tighter font-syne italic">Risk_Neural_Dial</h4>
              </div>
              <p className="text-[10px] text-white/20 font-black uppercase tracking-[0.3em] leading-relaxed italic font-syne">95% Confidence Interval — Daily VaR Probe</p>
            </div>
            ...
            <div className="text-center mt-8 space-y-4 relative z-10 w-full">
              <h2 className="text-5xl font-black text-white font-syne italic tracking-tighter">$8,240</h2>
              <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">MAX_LTM_EXPOSURE</p>
              <div className="px-6 py-3 rounded-[20px] bg-amber-500/10 border border-amber-500/20 w-fit mx-auto">
                <span className="text-[10px] font-black text-amber-500 uppercase tracking-[0.3em] font-syne italic">BUFFER: 85%_ACTIVE</span>
              </div>
                ...
                {riskZones.map((z) => (
                  <div key={z.label} className="space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[9px] font-black uppercase tracking-wider font-syne italic" style={{ color: z.color }}>{z.label}</span>
                      <span className="text-[9px] font-black text-white/20 font-syne italic">{z.pct}%</span>
                    </div>
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <Card className="p-10 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] h-full relative overflow-hidden group rounded-[40px]">
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 mb-8 relative z-10">
              <div className="space-y-3">
                <div className="flex items-center gap-4">
                  ...
                  <h4 className="text-xl font-black text-white uppercase tracking-tighter font-syne italic">Stress_Profile_Lattice</h4>
                </div>
                <p className="text-[10px] text-white/20 font-black uppercase tracking-[0.3em] leading-relaxed italic font-syne max-w-md">
              ...
              <div className="flex bg-red-500/5 px-6 py-4 rounded-[24px] border border-red-500/20 shrink-0">
                <div className="flex flex-col items-end gap-1">
                  <span className="text-[9px] font-black text-red-500/40 uppercase tracking-[0.3em] font-syne italic">PEAK_VARIANCE</span>
                  <span className="text-2xl font-black text-red-500 font-syne italic tracking-tighter">-12.48%</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex items-center gap-5 bg-white/[0.02] p-5 rounded-[24px] border border-white/5 relative z-10">
              ...
              <p className="text-[11px] text-white/30 font-black uppercase tracking-[0.3em] leading-relaxed italic font-syne">
            ...
            <Card className="p-8 border-2 border-white/5 bg-black/40 backdrop-blur-3xl hover:border-white/20 transition-all duration-700 overflow-hidden relative group h-full rounded-[32px] shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex items-center gap-6 relative z-10">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] font-syne italic">{m.label}</p>
                  <h4 className="text-2xl font-black text-white font-syne italic tracking-tighter mt-1">{m.val}</h4>
                  <p className="text-[9px] text-white/10 font-black uppercase tracking-[0.2em] mt-1 font-syne truncate">{m.sub}</p>
                </div>
              </div>
            </Card>
          </motion.div>
        ...
        <Card className="p-10 border-2 border-white/5 bg-black/40 backdrop-blur-3xl shadow-[0_40px_80px_rgba(0,0,0,0.6)] relative overflow-hidden group rounded-[40px]">
          <div className="mb-8 relative z-10">
            <div className="flex items-center gap-4">
              ...
              <h4 className="text-lg font-black text-white uppercase tracking-tighter font-syne italic">Scenario_Stress_Matrix</h4>
            </div>
            <p className="text-[10px] text-white/20 font-black uppercase tracking-[0.3em] mt-3 italic font-syne">Simulated portfolio impact under historical stress regimes</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative z-10">
            {[
              ...
              <div key={i} className={cn(
                ...
                <p className="text-[9px] font-black text-white/30 uppercase tracking-[0.3em] font-syne italic leading-relaxed">{s.scenario}</p>
                <p className={cn('text-2xl font-black font-syne italic tracking-tighter mt-3',
                  s.impact.startsWith('+') ? 'text-emerald-400' : 'text-red-400'
                )}>{s.impact}</p>
                <span className={cn(
                  'text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full border font-syne italic mt-2 inline-block',
