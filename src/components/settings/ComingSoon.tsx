...
const ComingSoon: React.FC<ComingSoonProps> = ({ 
  ...
  <div className={cn("h-[500px] flex flex-col items-center justify-center space-y-10 text-center relative overflow-hidden", className)}>
    ...
    <div className="relative group">
        <div className="absolute -inset-6 bg-primary/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 animate-pulse-slow font-syne" />
    ...
    <div className="space-y-4 relative z-10">
        <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.5em]">System Access Restricted</span>
        </div>
        <h2 className="text-4xl font-black text-white uppercase italic tracking-tighter drop-shadow-2xl">{title}</h2>
        <p className="text-[12px] text-white/40 font-black uppercase tracking-[0.2em] italic">{description}</p>
    </div>
    ...
    <div className="pt-8 space-y-6">
        ...
        <div className="flex items-center justify-center gap-8">
            <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-black text-white/20 uppercase tracking-widest">Compiling Assets</span>
            </div>
            <div className="flex items-center gap-2">
                <Zap className="w-3 h-3 text-amber-500" />
                <span className="text-[9px] font-black text-white/20 uppercase tracking-widest">L2 Finalizing</span>
            </div>
        </div>
    </div>
  </div>
