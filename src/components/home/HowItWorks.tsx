        ...
        <div className="flex flex-col lg:flex-row gap-24 items-start">
          ...
          <div className="lg:w-[40%] lg:sticky lg:top-32">
            <FadeUp>
              ...
              <h3 className="text-5xl md:text-7xl font-display font-bold mb-10 leading-[0.9]">
                Your Path to <br />
              ...
              <div className="p-8 rounded-[32px] bg-primary/5 border border-primary/10 relative overflow-hidden group">
                ...
                <p className="text-lg text-primary font-bold italic leading-relaxed relative z-10">
