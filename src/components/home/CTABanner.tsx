      ...
      <div className="container mx-auto px-6">
        <div className="relative rounded-[64px] bg-white/[0.02] border border-white/5 p-20 md:p-32 overflow-hidden group backdrop-blur-3xl shadow-[0_0_100px_rgba(0,0,0,1)]">
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto">
            <FadeUp>
              <div className="inline-flex items-center gap-4 px-6 py-2 rounded-xl bg-p/10 border border-p/20 text-p text-[10px] font-black uppercase tracking-[0.6em] mb-12 font-syne relative overflow-hidden">
              ...
              <h2 className="text-6xl md:text-[110px] font-syne font-black mb-12 leading-[0.85] tracking-tighter uppercase italic text-white">
              ...
              <p className="text-2xl md:text-3xl text-white/40 mb-20 leading-relaxed max-w-3xl mx-auto italic font-syne font-medium tracking-tight">
              ...
              <div className="flex flex-wrap items-center justify-center gap-10">
                <Link href="/register">
                  <Button size="lg" className="h-24 px-16 text-2xl bg-p hover:bg-indigo-500 rounded-[32px] group shadow-[0_30px_60px_rgba(99,102,241,0.5)] transition-all duration-700 font-syne font-black tracking-[0.1em] uppercase italic relative overflow-hidden">
                ...
                <Link href="/dashboard">
                  <Button size="lg" variant="ghost" className="h-24 px-16 text-2xl border-2 border-white/5 bg-white/[0.02] hover:bg-white/[0.08] rounded-[32px] font-syne font-black uppercase italic text-white/40 hover:text-white transition-all shadow-inner tracking-widest">
                    Access Sandbox
                  </Button>
                </Link>
              </div>
              ...
              <div className="mt-24 pt-16 border-t border-white/5 flex flex-wrap justify-center gap-20 opacity-30">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.4em] font-syne group hover:text-white transition-colors">
