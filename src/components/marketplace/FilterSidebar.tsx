    ...
    <aside className={cn(
      ...
      <div className="p-6 border-b border-white/[0.05] flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
            <span className="w-5 h-5 rounded-full bg-p/20 flex items-center justify-center text-[10px] font-black text-p">
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h4 className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Monthly Fee</h4>
            <span className="text-[10px] font-black text-white font-mono">₹0 - ₹{price.toLocaleString()}</span>
          </div>
          <div className="relative pt-2">
            ...
            <div className="flex items-center justify-between mt-3 px-1">
                <span className="text-[8px] font-bold text-white/20 uppercase tracking-widest">Free</span>
                <span className="text-[8px] font-bold text-white/20 uppercase tracking-widest">Premium Elite</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h4 className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Risk Exposure</h4>
        ...
        {/* Asset Class */}
        <div className="space-y-4">
          <h4 className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Asset Universe</h4>
        ...
        {/* Timeframes */}
        <div className="space-y-4">
          <h4 className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Resolution</h4>
          <div className="grid grid-cols-3 gap-2">
             {TIMEFRAMES.map((tf) => (
               <button
                 key={tf}
                 className="py-2.5 rounded-xl bg-white/5 border border-white/5 text-[10px] font-bold text-white/20 hover:text-white hover:border-white/10 transition-all"
               >
                 {tf}
               </button>
             ))}
        ...
        <div className="pt-4">
            <div className="p-4 rounded-2xl glass-strong border border-white/5 flex items-center justify-between">
                <div className="flex flex-col">
                    <span className="text-[10px] font-black text-white uppercase tracking-widest">Verified Only</span>
                    <span className="text-[8px] text-white/30 font-bold uppercase tracking-tighter mt-0.5">Show only audited creators</span>
                </div>
      ...
      <div className="p-8 space-y-3">
        <Button className="w-full h-12 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-[10px] uppercase tracking-[0.2em] shadow-2xl shadow-indigo-600/20 active:scale-95 transition-all">
          Apply Filters
        </Button>
        <button 
          onClick={() => {
          ...
          className="w-full text-[10px] font-black text-red-400/50 hover:text-red-400 uppercase tracking-[0.3em] transition-colors py-2"
        >
          Reset All
        </button>
      </div>
