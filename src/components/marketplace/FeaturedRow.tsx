  ...
  return (
    <div className="space-y-4 pt-8">
      <div className="flex items-center justify-between px-8">
        <h2 className="text-lg font-bold text-white font-syne uppercase tracking-wider">
          Featured Strategies
        </h2>
        <div className="flex gap-2">
            <div className="w-2 h-2 rounded-full bg-p animate-pulse" />
            <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Verified High Performers</span>
        </div>
      </div>
        ...
        {FEATURED_DATA.map((strategy) => (
          ...
          >
            ...
            <div className="absolute top-6 right-6">
                <div className="px-3 py-1 rounded-full bg-indigo-500 text-white text-[9px] font-black uppercase tracking-[0.2em] shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                    Featured
                </div>
            </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 flex items-end justify-between">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-3">
                   <h3 className="text-xl font-bold text-white font-syne tracking-tight">
                    {strategy.name}
                  </h3>
                  <div className="px-2 py-0.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-black">
                    {strategy.returns}
                  </div>
                </div>
              ...
              <Button 
                variant="ghost" 
                className="h-10 px-6 rounded-xl glass border border-white/10 hover:border-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em] transition-all group/btn"
              >
                Subscribe 
