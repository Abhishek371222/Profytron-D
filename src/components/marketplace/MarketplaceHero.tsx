    ...
    <section className="h-[200px] w-full relative overflow-hidden bg-[#0f0e2a]">
      ...
      <div className="relative h-full px-8 flex items-center justify-between">
        ...
        <div className="flex flex-col gap-1">
          <span className="text-[11px] font-medium text-p uppercase tracking-[0.3em] font-dm-sans">
            Marketplace
          </span>
            ...
            {STATS.map((stat, i) => (
              <div key={stat.label} className="flex items-center gap-3">
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-white font-jet-mono tracking-tighter">
                    <span className="text-p/50 mr-0.5">{stat.prefix}</span>
                    {stat.value}
                  </span>
                  <span className="text-[9px] text-white/30 uppercase font-bold tracking-widest">{stat.label}</span>
                </div>
                {i < STATS.length - 1 && (
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            {[
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-black text-white/30 uppercase tracking-widest">Strategy</span>
