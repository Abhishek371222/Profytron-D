...
export default function RiskOnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          {!isFinalizing ? (
            ...
            >
              ...
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                   <h1 className="text-4xl font-black uppercase tracking-tight italic font-syne">{step.title}</h1>
              ...
              <div className="space-y-3">
                 <div className="flex justify-between items-end text-[10px] font-black uppercase tracking-[0.4em] text-white/20">
              ...
              <div className="space-y-10">
                 {step.questions.map((q) => (
                    <div key={q.id} className="space-y-6">
                       <label className="text-[11px] font-black text-white/30 uppercase tracking-[0.3em] flex items-center gap-3">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                          {q.options.map((option) => (
                             <button
                                ...
                                className={cn(
                                   "h-16 rounded-2xl border transition-all duration-500 font-black text-xs uppercase tracking-widest relative overflow-hidden",
                                   answers[q.id] === option 
              ...
              <Button 
                ...
                className="w-full h-16 bg-white text-black hover:bg-white/90 rounded-2xl font-black uppercase tracking-widest text-lg group shadow-2xl disabled:opacity-30 disabled:grayscale transition-all"
              >
            ...
            >
               ...
               <div className="space-y-2">
                  <h2 className="text-3xl font-black uppercase tracking-[0.2em] font-syne italic">Analyzing Profile DNA...</h2>
               ...
               <div className="bg-white/5 border border-white/10 p-6 rounded-[32px] space-y-4 max-w-sm mx-auto">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest">System Protocols Engaged</span>
                  </div>
                  <div className="flex items-center gap-3">
                     <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                     <span className="text-[10px] font-black text-primary uppercase tracking-widest">Hardware Keys Validated</span>
                  </div>
               </div>
            </motion.div>
          )}
      ...
      {/* Footer Branding */}
      <div className="absolute bottom-10 flex items-center gap-10 opacity-20 text-[10px] font-black uppercase tracking-[0.5em]">
         <div className="flex items-center gap-3">
