  ...
  return (
    <div className="space-y-8 max-w-4xl w-full mx-auto px-6">
      <div className="text-center space-y-4">
        <h2 className="text-5xl font-display font-black tracking-tight text-white italic">
        ...
        <div className="relative z-10 space-y-10">
          <div className="py-8">
            <motion.div 
              ...
              className="text-7xl lg:text-8xl font-display font-black tracking-tighter text-white"
            >
          ...
          <div className="relative pt-6 pb-2">
            ...
            <div className="flex justify-between mt-6 text-[10px] uppercase font-bold text-white/20 tracking-widest">
              <span>$10k (Alpha)</span>
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {s.tags.map(tag => (
                    <span key={tag} className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] uppercase font-bold tracking-widest text-white/40">{tag}</span>
                  ))}
                </div>
              </div>
            </div>
...
const StepFinalizing = () => {
  return (
    <div className="space-y-12 max-w-lg w-full mx-auto text-center">
      ...
      <div className="space-y-4">
        <h2 className="text-4xl font-display font-black tracking-tight text-white mb-2">Neural <span className="text-p">Synchronization.</span></h2>
      ...
      <header className="fixed top-0 inset-x-0 h-24 z-50 px-12 flex items-center justify-between pointer-events-none">
        <div className="bg-bg-card/40 backdrop-blur-xl border border-white/5 px-6 py-2 rounded-full pointer-events-auto flex items-center gap-4 shadow-2xl">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold text-white/20 uppercase tracking-widest">Setup Phase</span>
        ...
        <div className="bg-bg-card/40 backdrop-blur-xl border border-white/5 px-6 py-3 rounded-full pointer-events-auto flex items-center gap-4 shadow-2xl">
          ...
          <span className="text-[10px] font-bold text-white/40 uppercase tracking-[0.2em]">Institutional Access Level: 2</span>
        </div>
      </header>
      ...
      {step < 4 && (
        <footer className="fixed bottom-12 inset-x-0 z-50 px-12 flex items-center justify-between">
          ...
          <Magnetic strength={0.3}>
            <Button
              onClick={nextStep}
              className="h-16 px-12 bg-gradient-to-r from-p to-p-dark text-white font-black text-xl rounded-2xl flex items-center gap-4 transition-all shadow-2xl shadow-p/40 group relative overflow-hidden"
            >
          ...
          <div className="hidden lg:flex items-center gap-3 text-white/20 font-bold text-[10px] uppercase tracking-[0.3em]">
