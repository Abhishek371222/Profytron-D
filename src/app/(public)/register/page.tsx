        ...
        <div className="relative bg-bg-card/40 backdrop-blur-3xl border border-white/10 rounded-[40px] p-10 lg:p-14 shadow-2xl overflow-hidden group">
          ...
          <motion.div variants={itemVariants} className="text-center space-y-4 mb-12">
            ...
            <h2 className="text-5xl font-display font-bold text-white tracking-tight">
              Join the <span className="text-gradient-s italic">grid.</span>
            </h2>
          ...
          <motion.div variants={itemVariants} className="relative flex items-center gap-4 mb-10">
            ...
            <span className="text-[10px] uppercase tracking-widest font-black text-white/20">Institutional Entry</span>
            <div className="h-px flex-1 bg-white/10" />
          </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-4">
              <Magnetic strength={0.3}>
                <Button 
                  ...
                  className="w-full h-16 bg-gradient-to-r from-s to-s-dark text-white font-black text-xl rounded-2xl transition-all shadow-2xl shadow-s/40 group relative overflow-hidden disabled:opacity-50"
                >
          ...
          <motion.div variants={itemVariants} className="mt-12 text-center">
            <p className="text-slate-500 text-sm">
              Already authorized?{' '}
              <Link href="/login" className="text-white font-black hover:text-s transition-colors underline-offset-4 underline decoration-s/30">
                Sign In to Terminal
              </Link>
            </p>
          </motion.div>
