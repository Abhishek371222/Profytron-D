      ...
      <div className="mb-4 last:mb-0">
        <div className="flex justify-between items-end mb-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex items-center gap-1 text-[10px] uppercase font-bold text-slate-400 hover:text-white bg-slate-800 hover:bg-slate-700 px-2 py-0.5 rounded transition-colors">
                      ...
                      <tr>
                        <td colSpan={6} className="p-0 border-none bg-black">
                          ...
                          >
                            ...
                            <pre className="text-red-400/80 bg-red-950/20 p-4 rounded-lg border border-red-900/30 overflow-x-auto whitespace-pre-wrap font-mono text-[11px] leading-relaxed">
                              {err.stackTrace}
                            </pre>
