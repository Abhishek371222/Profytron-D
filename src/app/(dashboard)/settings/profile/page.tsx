        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 group/identity">
          <div className="relative group/avatar">
            ...
            <Magnetic strength={0.3}>
              <button className="absolute bottom-4 right-4 w-14 h-14 rounded-[22px] bg-primary border-4 border-[#08080a] flex items-center justify-center text-white shadow-[0_20px_40px_rgba(99,102,241,0.4)] hover:scale-110 active:scale-95 transition-all z-30">
          ...
          <div className="space-y-6 flex-1 text-center lg:text-left">
            <div className="space-y-2">
              <div className="flex items-center justify-center lg:justify-start gap-4">
                <h3 className="text-5xl font-semibold text-white uppercase tracking-tighter leading-none">Arjun Khanna</h3>
              ...
              <p className="text-[11px] text-white/20 font-bold uppercase tracking-[0.6em] font-mono">NODE_HASH: PX_7719_SYNC_44</p>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-12 pt-4">
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className="text-sm font-semibold text-white tracking-[0.2em] uppercase">Apex_Prime_Plus</span>
                </div>
              </div>
