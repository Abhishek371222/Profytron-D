...
export default function SecuritySettingsPage() {
 ...
 <label className="text-xs font-semibold text-white/20 uppercase tracking-[0.5em] ml-1 group-focus-within:text-p transition-colors">{label}</label>
 ...
 <Button className="h-12 px-8 rounded-[16px] bg-white/5 border border-white/10 hover:bg-white/10 font-semibold uppercase tracking-[0.2em] text-xs text-white/40 hover:text-white transition-all">
 Rotate Secure Key
 </Button>
 </section>
...
"w-20 h-10 rounded-full border transition-all p-1.5 flex shrink-0",
 ...
 <span className="text-sm font-semibold text-white uppercase tracking-tight">{s.device}</span>
 <span className="text-xs font-semibold text-white/20 uppercase font-jet-mono">{s.ip}</span>
 </div>
 <div className="flex items-center gap-3 mt-1">
 <span className="text-xs text-white/30 font-semibold uppercase tracking-widest">{s.browser}</span>
