    ...
    <div className="space-y-16 pb-20">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-5">
            ...
            <div className="space-y-1">
              <h3 className="text-3xl font-black text-white uppercase italic tracking-tighter font-syne">Neural Alerts</h3>
              <p className="text-[10px] text-p/60 font-black uppercase tracking-[0.3em]">Configure real-time telemetry relay channels</p>
            </div>
          </div>
          <div className="hidden md:flex items-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-ping" />
              <span className="text-[9px] font-black text-emerald-400 uppercase tracking-widest">Relay Active</span>
            </div>
          </div>
        </div>
          ...
          {NOTIF_CHANNELS.map((ch) => (
            ...
            >
              ...
              <div className="space-y-1 relative z-10">
                <h4 className="text-sm font-black text-white uppercase tracking-widest italic">{ch.label}</h4>
                <p className="text-[10px] text-white/30 font-black uppercase tracking-widest">{ch.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="space-y-10">
        <div className="flex items-center gap-6">
          ...
          <h4 className="text-2xl font-black text-white uppercase italic tracking-tighter font-syne">Signal Hierarchy</h4>
              ...
              <div className="flex items-center gap-8 flex-1">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    <h5 className="text-xl font-black text-white uppercase italic tracking-tighter font-syne">{type.label}</h5>
                    <span className={cn(
                  ...
                  <p className="text-[11px] text-white/30 font-black uppercase tracking-[0.2em] mt-2 max-w-md">
                    {type.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="space-y-10">
        <div className="flex items-center gap-6">
          ...
          <h4 className="text-2xl font-black text-white uppercase italic tracking-tighter font-syne">Terminal Soundscape</h4>
          <div className="h-px flex-1 bg-white/5" />
        </div>
        ...
        <div className="p-10 rounded-[40px] bg-gradient-to-br from-[#0c0c0c] to-[#050505] border border-white/5 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
            <div className="space-y-4">
              <h5 className="text-xl font-black text-white uppercase italic tracking-tighter font-syne">Auditory Feedback Protocol</h5>
            ...
            <div className="flex items-center gap-4">
               {['Muted', 'Ambient', 'High Alert'].map((mode, i) => (
                 <button 
                  key={mode}
                  className={cn(
                    "px-8 py-4 rounded-[20px] text-[10px] font-black uppercase tracking-widest border transition-all",
