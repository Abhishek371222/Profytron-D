      ...
      >
        <div className="space-y-4">
            <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] font-black text-p uppercase tracking-[0.5em] leading-none">Institutional Terminal v2.4</span>
            </div>
            <h1 className="text-5xl font-black text-white uppercase tracking-tighter font-syne leading-none">Analytics</h1>
        ...
        <div className="flex items-center gap-6">
            <div className="flex items-center gap-4 px-6 py-3.5 rounded-[22px] bg-white/[0.03] border border-white/5 group hover:border-white/15 transition-all cursor-pointer shadow-2xl backdrop-blur-3xl">
                ...
                <div className="flex items-center gap-4 text-[11px] font-black text-white/60 uppercase tracking-[0.2em] font-jet-mono">
            ...
            <Button variant="ghost" className="h-[52px] px-8 rounded-[22px] border border-white/10 hover:bg-white/10 gap-4 group shadow-xl hover:shadow-p/10 transition-all duration-500">
                ...
                <span className="text-[11px] font-black text-white/40 group-hover:text-white uppercase tracking-[0.2em]">Export Dataset</span>
            </Button>
        </div>
      </motion.div>
      ...
      >
        {TABS.map((tab) => (
            <button
                ...
                className={cn(
                    "relative px-10 py-4 rounded-[24px] text-[11px] font-black uppercase tracking-[0.2em] transition-all duration-500",
                    activeTab === tab.id 
                        ? "text-white" 
