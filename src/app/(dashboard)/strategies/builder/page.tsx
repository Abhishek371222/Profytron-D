  ...
  return (
    <div className="h-[calc(100vh-140px)] flex relative overflow-hidden bg-[#050508]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-tr from-primary/5 via-transparent to-indigo-500/5" />
        <div className="absolute top-1/4 left-1/3 w-[800px] h-[800px] bg-primary/10 blur-[200px] rounded-full animate-pulse" />
      </div>
        ...
        >
            ...
            <div className="flex items-center gap-8">
              <Magnetic strength={0.2}>
                <button
                  ...
                  className="w-14 h-14 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary hover:bg-primary/20 transition-all shadow-[0_0_30px_rgba(99,102,241,0.2)] active:scale-90"
                >
              ...
              <div className="flex flex-col gap-2">
                <div className="relative group">
                  <input
                    ...
                    className="bg-white/[0.03] border border-white/10 rounded-xl px-6 py-2.5 text-white font-bold focus:border-primary/40 focus:outline-none transition-all text-[15px] w-72 uppercase tracking-tight placeholder:text-white/10"
          ...
          <div className="flex items-center gap-6">
            <Magnetic strength={0.1}>
              <Button variant="ghost" className="w-16 h-16 rounded-[22px] bg-white/[0.02] border border-white/5 text-white/20 hover:text-white hover:border-white/20 transition-all group/save">
            ...
            <Magnetic strength={0.2}>
              <Button 
                ...
                className={cn(
                  ...
                  isSimulating ? "bg-emerald-500 text-white shadow-emerald-500/40" : "bg-primary text-white shadow-primary/40"
                )}
              >
        ...
        <main className="flex-1 relative overflow-hidden group/canvas" ref={reactFlowWrapper}>
          ...
          <ReactFlowProvider>
            ...
            >
              ...
              <Controls 
                className="!bg-black/80 !border !border-white/10 !rounded-[24px] !fill-white/30 !shadow-2xl overflow-hidden backdrop-blur-3xl !m-12 !p-3 !flex-row !gap-6 border-b-4 border-b-primary/20" 
              ...
              <Panel position="top-right" className="m-12">
                ...
                >
                  ...
                  <div className="relative group/hex">
                    <div className="absolute inset-0 bg-primary/20 blur-[40px] rounded-full scale-0 group-hover/panel:scale-100 transition-transform duration-1000" />
                    <div className="w-24 h-24 rounded-[32px] bg-white/[0.01] border border-white/10 flex items-center justify-center relative z-10 group-hover/panel:border-primary/40 transition-all duration-700 shadow-inner">
                      <Activity className="w-12 h-12 text-white/10 group-hover/panel:text-primary transition-colors duration-500" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-10 w-full relative z-10">
                    <div className="flex flex-col items-center gap-2 group/stat">
                      <span className="text-4xl font-semibold text-white tracking-tighter group-hover/stat:text-primary transition-colors duration-500">8.42%</span>
                      <div className="flex items-center gap-3">
                        <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse shadow-[0_0_10px_#6366f1]" />
                        <span className="text-[10px] font-bold text-white/10 uppercase tracking-[0.5em]">Expected_Yield</span>
                      </div>
                    </div>
                    <div className="flex flex-col items-center gap-2 group/stat">
                      <span className="text-4xl font-semibold text-emerald-400 tracking-tighter">1.82</span>
                      <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <div className="flex items-center gap-8 relative z-10">
                    <div className="relative">
                      <div className="w-4 h-4 rounded-full bg-primary shadow-[0_0_20px_#6366f1] animate-pulse" />
                  ...
                  <div className="flex items-center gap-6 relative z-10 ml-6 min-w-[240px]">
                    ...
                    <span className="text-[11px] font-bold text-primary uppercase tracking-[0.5em] font-mono">MEMORY: 84%</span>
                  </div>
                </motion.div>
              </Panel>
            </ReactFlow>
