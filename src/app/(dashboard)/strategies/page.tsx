...
"grid gap-8",
 ...
 <div className="flex items-center gap-3 text-p font-jet-mono text-xs uppercase tracking-[0.3em] font-semibold">
 ...
 <div>
 <h4 className="font-semibold text-white text-2xl tracking-tight uppercase">{selectedStrategy?.name}</h4>
 ...
 <p className="text-2xl font-semibold text-emerald-400">+{selectedStrategy?.returns}%</p>
 </div>
 ...
 <p className="text-2xl font-semibold text-rose-400">-{selectedStrategy?.drawdown}%</p>
 </div>
 <div className="space-y-2 border-l border-white/5 pl-4">
 <p className="text-xs text-white/30 uppercase font-semibold tracking-widest">Sharpe Ratio</p>
 <p className="text-2xl font-semibold text-cyan-400">{selectedStrategy?.sharpe}</p>
 </div>
 </div>
 </div>
 ...
 <Button onClick={() => setActivationStep(2)} className="h-14 flex-[2] bg-white text-black hover:bg-white/90 rounded-[16px] font-semibold text-xs uppercase tracking-[0.2em] shadow-[0_0_30px_rgba(255,255,255,0.1)]">Authenticate Logic &rarr;</Button>
 </div>
 </motion.div>
 )}
 ...
 <Button onClick={() => setActivationStep(3)} className="h-14 flex-[2] bg-p hover:bg-p-hover text-white rounded-[16px] font-semibold text-xs uppercase tracking-[0.2em] shadow-[0_0_30px_rgba(99,102,241,0.2)]">Sign Logic Contract</Button>
 </div>
 </motion.div>
 )}
 ...
 <p className="font-semibold text-xl text-white">{mockUser.connectedAccounts[0]}</p>
 </div>
 </div>
 ...
 <h3 className="text-2xl font-semibold text-white uppercase tracking-tight animate-pulse">
 {activationStep === 3.5 ? 'Negotiating Neural Handshake' : 'Finalizing Cryptographic Logic'}
 </h3>
 <p className="text-xs font-jet-mono text-white/30 uppercase tracking-[0.3em]">Connecting to global liquidity pools...</p>
 </div>
 </motion.div>
 )}
...
function CinematicStrategyCard({ strategy, index, viewMode, onActivate }: any) {
 ...
 <span className="text-sm font-semibold font-jet-mono text-emerald-400">+{strategy.winRate}%</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-semibold text-white/30 uppercase tracking-widest">Sharpe</span>
 <span className="text-sm font-semibold font-jet-mono text-cyan-400">{strategy.sharpe}</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-semibold text-white/30 uppercase tracking-widest">Network Nodes</span>
 <span className="text-sm font-semibold font-jet-mono text-white">{strategy.subscribers.toLocaleString()}</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-semibold text-white/30 uppercase tracking-widest">Access Protocol</span>
 <span className="text-sm font-semibold font-jet-mono text-white">{strategy.price > 0 ? `$${strategy.price}/mo` : 'OPEN'}</span>
 </div>
 </div>
 </div>
...
"relative w-full h-full flex flex-col p-6 rounded-[30px] bg-[#050505] border transition-colors duration-500 overflow-hidden cursor-pointer",
 ...
 <div className="flex flex-col">
 <span className="text-xs font-semibold font-jet-mono uppercase tracking-[0.2em] text-white/30">Cmdr // {strategy.creator}</span>
 {strategy.verified && <span className="text-xs text-emerald-400 uppercase tracking-widest font-semibold mt-0.5">Verified Identity</span>}
 </div>
 </div>
 <div className={cn(
