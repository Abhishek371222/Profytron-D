      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 border-b-2 border-white/5 pb-12 relative">
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[12px] font-black text-p uppercase tracking-[0.6em] font-syne italic">Vault_Secure_Terminal_v4.2</span>
            </div>
            <h1 className="text-6xl font-black text-white uppercase tracking-tighter font-syne leading-none italic">Treasury_Vault</h1>
            <p className="text-sm text-white/30 font-black uppercase tracking-[0.3em] font-syne italic">Secure_Institutional_Liquidity_&_Asset_Custodianship_Protocol</p>
        </div>
        ...
        <div className="flex items-center gap-2 bg-white/5 p-2.5 rounded-[32px] border-2 border-white/10 backdrop-blur-3xl shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
          {TABS.map((tab) => (
            <button
              ...
              className={cn(
                "px-8 py-4 rounded-[24px] text-[11px] font-black uppercase tracking-[0.3em] transition-all duration-700 flex items-center gap-3 font-syne italic",
                    ...
                    <div className="space-y-20">
                       <div className="space-y-10">
                          <div className="flex items-center gap-5">
                              <span className="text-[13px] font-black text-white/20 uppercase tracking-[0.8em] font-syne italic">Aggregated_Liquidity_Module</span>
                          ...
                          <div className="flex items-center gap-8">
                            ...
                            <div className="flex items-baseline gap-8">
                              <span className="text-5xl font-black text-p font-syne italic opacity-40 leading-none">$</span>
                              <h2 className="text-[10rem] font-black text-white font-syne tracking-tighter tabular-nums drop-shadow-[0_30px_30px_rgba(0,0,0,0.8)] leading-none -ml-4">
                                1,24,580<span className="opacity-20">.00</span>
                              </h2>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-16 pt-16 border-t-2 border-white/5">
                            <div className="flex flex-col gap-4">
                                <span className="text-[11px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">INSTITUTIONAL_RESERVE</span>
                                <div className="flex items-center gap-4 group/metric">
                                    ...
                                    <span className="text-4xl font-black text-emerald-400 font-syne italic tracking-tighter group-hover/metric:scale-110 transition-transform">$98,240.50</span>
                                </div>
                            </div>
                            <div className="w-[2px] h-20 bg-gradient-to-b from-transparent via-white/10 to-transparent" />
                            <div className="flex flex-col gap-4">
                                <span className="text-[11px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">PENDING_SETTLEMENT</span>
                                <div className="flex items-center gap-4 group/metric">
                                    <div className="w-2 h-2 rounded-full bg-amber-500 shadow-[0_0_20px_#f59e0b]" />
                                    <span className="text-4xl font-black text-amber-500 font-syne italic tracking-tighter group-hover/metric:scale-110 transition-transform">$26,339.50</span>
                                </div>
                            </div>
                          </div>
                       </div>
                       ...
                       <div className="flex gap-8">
                          <Magnetic strength={0.2}>
                            <motion.button 
                              ...
                              className="h-24 px-16 bg-p text-white font-black uppercase tracking-[0.5em] rounded-[32px] shadow-[0_0_60px_rgba(99,102,241,0.5)] transition-all group overflow-hidden relative font-syne italic text-lg"
                            >
                          ...
                          <Magnetic strength={0.1}>
                            <motion.button 
                              ...
                              className="h-24 px-16 glass-ultra border-2 border-white/10 hover:bg-white/5 text-white/50 font-black uppercase tracking-[0.5em] rounded-[32px] font-syne italic text-lg hover:text-white transition-all"
                            >
                              Withdrawal_Gateway
                            </motion.button>
                          </Magnetic>
                    ...
                    <div className="flex flex-col justify-between py-6 border-l-2 border-white/5 pl-24 bg-black/20 rounded-[48px]">
                       <div className="space-y-10">
                          <div className="flex items-center justify-between">
                            <span className="text-[13px] font-black text-white/20 uppercase tracking-[0.5em] font-syne italic">Vault_Volume_Velocity</span>
                            <span className="text-[11px] font-black text-emerald-400 uppercase tracking-[0.3em] bg-emerald-500/10 px-4 py-2 rounded-2xl border-2 border-emerald-500/20 font-syne italic">+14.2%_EPOCH_GROWTH</span>
                          </div>
                          <div className="h-[280px] w-full flex items-end gap-3 bg-black/40 rounded-[40px] border-2 border-white/5 p-10 relative overflow-hidden group/chart shadow-inner">
                            ...
                            {[35, 42, 38, 55, 47, 62, 58, 65, 70, 68, 82, 75, 85, 90, 88].slice(-14).map((v, i) => (
                              ...
                              >
                                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 px-4 py-2 bg-p text-white text-[10px] font-black rounded-xl opacity-0 group-hover/bar:opacity-100 transition-all pointer-events-none shadow-[0_20px_40px_rgba(0,0,0,0.8)] scale-75 group-hover/bar:scale-100 italic border border-white/20 font-syne z-50 whitespace-nowrap">
                       ...
                       <div className="grid grid-cols-2 gap-16 pt-16">
                          <div className="space-y-4">
                             <div className="flex items-center gap-4">
                                ...
                                <span className="text-3xl font-black text-white font-syne italic tracking-tighter group-hover:scale-110 transition-transform">+$45,240</span>
                             </div>
                             <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">INFLOW_TOTAL_PERIOD</p>
                          </div>
                          <div className="space-y-4">
                             <div className="flex items-center gap-4">
                                ...
                                <span className="text-3xl font-black text-white font-syne italic tracking-tighter group-hover:scale-110 transition-transform">-$12,400</span>
                             </div>
                             <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic">OUTFLOW_TOTAL_PERIOD</p>
                          </div>
                       </div>
                    </div>
                  </div>
                    ...
                    <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 + (i * 0.1) }}>
                        <Card className="p-10 border-2 border-white/5 bg-black/40 backdrop-blur-3xl rounded-[40px] group hover:border-white/20 transition-all duration-1000 relative overflow-hidden shadow-2xl">
                            ...
                            <div className="flex items-center gap-8 relative z-10">
                                ...
                                <div>
                                    <p className="text-[11px] font-black text-white/20 uppercase tracking-[0.4em] font-syne italic leading-none">{stat.label}</p>
                                    <h4 className="text-2xl font-black text-white mt-3 italic tracking-tighter font-syne leading-none">{stat.value}</h4>
                                </div>
                            </div>
                        </Card>
                    </motion.div>
          ...
          >
            <Card className="p-20 glass-ultra border-2 border-white/10 rounded-[64px] shadow-[0_60px_120px_rgba(0,0,0,0.9)] relative overflow-hidden group border-p/20">
                ...
                <div className="space-y-20 relative z-10">
                    <div className="flex items-center justify-between">
                        <div className="space-y-4">
                            <h3 className="text-6xl font-black text-white uppercase italic tracking-tighter font-syne leading-none">Liquidity_Influx_Entry</h3>
                            <p className="text-[12px] text-white/30 font-black uppercase tracking-[0.8em] font-syne italic">SECURE_PROTOCOL_QUANTUM_L3_NODE_v9.1</p>
                        </div>
                    ...
                    <div className="space-y-12">
                        <div className="relative group/input">
                            ...
                            <div className="relative h-40 flex items-center bg-white/[0.03] border-2 border-white/5 rounded-[44px] px-20 group-focus-within/input:border-p/40 transition-all duration-700 group-focus-within/input:bg-white/[0.08] shadow-2xl">
                                <span className="text-7xl font-black text-p/30 font-syne mr-12 italic mt-4">$</span>
                                <input 
                                    type="number"
                                    value={depositAmount}
                                    onChange={(e) => setDepositAmount(e.target.value)}
                                    placeholder="0,000.00"
                                    className="bg-transparent outline-none flex-1 text-8xl font-black text-white font-syne placeholder:text-white/5 tabular-nums tracking-tighter mt-4"
                                />
                                <div className="flex flex-col items-end gap-2 shrink-0">
                                   <span className="text-[11px] font-black text-white/10 uppercase tracking-[0.4em] font-syne">ENTRY_MODE</span>
                        ...
                        <div className="grid grid-cols-4 gap-6">
                            {[5000, 10000, 50000, 100000].map((amt) => (
                                <motion.button
                                    ...
                                    className="h-20 rounded-[28px] bg-white/[0.03] border-2 border-white/5 hover:border-p/50 hover:bg-p/5 text-[12px] font-black text-white/20 hover:text-white transition-all duration-500 uppercase tracking-[0.4em] font-syne italic"
                                >
                                    +${amt.toLocaleString()}
                                </motion.button>
                            ))}
                    ...
                    <div className="space-y-10">
                        <span className="text-[12px] font-black text-white/20 uppercase tracking-[0.8em] ml-4 font-syne italic">Gateway_Network_Protocol_Selection</span>
                                 ...
                                 >
                                    ...
                                    <div className="space-y-8 relative z-10">
                                        ...
                                        <div className="space-y-3">
                                            <p className="text-2xl font-black text-white uppercase tracking-tighter italic font-syne leading-none">{net.name}</p>
                                            <p className={cn("text-[11px] font-black uppercase tracking-[0.5em] font-syne", net.active ? "text-p" : "text-white/20")}>{net.desc}</p>
                                        </div>
                                    </div>
                                 </button>
                             ))}
                    ...
                    <div className="pt-20">
                      <Magnetic strength={0.1}>
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={cn(
                                "w-full h-32 rounded-[44px] text-white font-black uppercase tracking-[0.8em] text-2xl shadow-[0_40px_100px_rgba(99,102,241,0.5)] relative transition-all duration-1000 overflow-hidden font-syne italic",
                    ...
                    <div className="flex items-center justify-center gap-6 text-[11px] font-black text-white/5 uppercase tracking-[0.8em] pt-6 font-syne italic">
          ...
          >
            <Card className="p-20 glass-ultra border-2 border-white/10 rounded-[64px] shadow-[0_60px_120px_rgba(0,0,0,0.9)] relative overflow-hidden group border-amber-500/20">
                ...
                <div className="space-y-20 relative z-10">
                    <div className="flex items-center justify-between">
                        <div className="space-y-4">
                            <h3 className="text-6xl font-black text-white uppercase italic tracking-tighter font-syne leading-none">Liquidity_Outflux</h3>
                            <p className="text-[12px] text-white/30 font-black uppercase tracking-[0.8em] font-syne italic">WITHDRAWAL_GATEWAY_NODE_v1.4</p>
                        </div>
                    ...
                    <div className="space-y-12">
                        <div className="relative group/input">
                            ...
                            <div className="relative h-40 flex items-center bg-white/[0.03] border-2 border-white/5 rounded-[44px] px-20 group-focus-within/input:border-amber-500/40 transition-all duration-700 group-focus-within/input:bg-white/[0.08] shadow-2xl">
                                <span className="text-7xl font-black text-amber-500/30 font-syne mr-12 italic mt-4">$</span>
                                <input 
                                    type="number"
                                ...
                                />
                                <div className="flex flex-col items-end gap-2 shrink-0">
                                   <span className="text-[11px] font-black text-white/10 uppercase tracking-[0.4em] font-syne">OUTFLUX_MODE</span>
                        ...
                        <div className="grid grid-cols-4 gap-6">
                            {[1000, 5000, 10000, 25000].map((amt) => (
                                <motion.button
                                    ...
                                    className="h-20 rounded-[28px] bg-white/[0.03] border-2 border-white/5 hover:border-amber-500/50 hover:bg-amber-500/5 text-[12px] font-black text-white/20 hover:text-white transition-all duration-500 uppercase tracking-[0.4em] font-syne italic"
                                >
                                    -${amt.toLocaleString()}
                                </motion.button>
                            ))}
                    ...
                    <div className="space-y-10">
                        <span className="text-[12px] font-black text-white/20 uppercase tracking-[0.8em] ml-4 font-syne italic">Target_Settlement_Network</span>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                             {[
                                ...
                                { id: 'crypto', name: 'Cold Storage Vault', desc: 'INSTANT · MULTI_SIG_VERIFIED', icon: Wallet, color: 'text-amber-500', active: false },
                                 ...
                                 >
                                    ...
                                    <div className="space-y-8 relative z-10">
                                        ...
                                        <div className="space-y-3">
                                            <p className="text-2xl font-black text-white uppercase tracking-tighter italic font-syne leading-none">{net.name}</p>
                                            <p className={cn("text-[11px] font-black uppercase tracking-[0.5em] font-syne", net.active ? "text-amber-500" : "text-white/20")}>{net.desc}</p>
                                        </div>
                                    </div>
                                 </button>
                             ))}
                    ...
                    <div className="pt-20">
                      <Magnetic strength={0.1}>
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={cn(
                                "w-full h-32 rounded-[44px] text-white font-black uppercase tracking-[0.8em] text-2xl shadow-[0_40px_100px_rgba(245,158,11,0.4)] relative transition-all duration-1000 overflow-hidden font-syne italic",
        ...
        {activeTab === 'history' && (
          ...
          >
            <div className="flex items-center justify-between px-4">
                <div className="space-y-4">
                     <h3 className="text-4xl font-black text-white uppercase italic tracking-tighter font-syne leading-none">Global_Event_Ledger</h3>
                     <p className="text-[12px] text-white/20 font-black uppercase tracking-[0.8em] font-syne italic">Audit_Trail_Protocol_v84.0_RECURSIVE</p>
                </div>
                <div className="flex gap-6 items-center">
                     <div className="relative group">
                        ...
                        <input className="h-16 w-80 bg-white/[0.03] border-2 border-white/5 rounded-[24px] pl-16 pr-8 text-[11px] font-black uppercase tracking-widest text-white outline-none focus:border-p/40 transition-all duration-700 font-syne italic" placeholder="SEARCH_REFERENCE_HASH..." />
                     </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b-2 border-white/5 bg-white/[0.04]">
                      <th className="px-12 py-10 text-[11px] font-black text-white/40 uppercase tracking-[0.6em] font-syne italic">TAMPER_MARK</th>
                      <th className="px-12 py-10 text-[11px] font-black text-white/40 uppercase tracking-[0.6em] font-syne italic">EXEC_PROTOCOL</th>
                      <th className="px-12 py-10 text-[11px] font-black text-white/40 uppercase tracking-[0.6em] font-syne italic">INTELLIGENCE_METRIC</th>
                      <th className="px-12 py-10 text-[11px] font-black text-white/40 uppercase tracking-[0.6em] font-syne italic text-right">LIQUIDITY_QUANT</th>
                      <th className="px-12 py-10 text-[11px] font-black text-white/40 uppercase tracking-[0.6em] font-syne italic text-center">SYSTEM_STATE</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y-2 divide-white/[0.03]">
                    {TRANSACTIONS.map((tx, idx) => (
                      <motion.tr 
                        ...
                        className="group hover:bg-white/[0.07] transition-all duration-700 cursor-crosshair h-[120px]"
                      >
                        <td className="px-12 py-6 text-[15px] font-black text-white/30 font-jet-mono italic group-hover:text-white transition-colors duration-700">{tx.date}</td>
                        <td className="px-12 py-6">
                            <span className={cn(
                                "px-6 py-2.5 rounded-[18px] text-[11px] font-black uppercase tracking-[0.3em] border-2 font-syne italic shadow-2xl transition-all duration-700 group-hover:scale-110 group-hover:rotate-2 group-hover:translate-x-4",
                        ...
                        <td className="px-12 py-6 space-y-3">
                            <p className="text-lg font-black text-white uppercase tracking-tight group-hover:text-p transition-colors duration-700 font-syne italic">{tx.description}</p>
                            <p className="text-[10px] font-black text-white/10 uppercase tracking-[0.4em] font-mono group-hover:text-white/30 transition-colors">REF_HASH: {tx.reference}</p>
                        </td>
                        <td className="px-12 py-6 text-right">
                          <span className={cn(
                              "text-3xl font-black font-syne tracking-tighter italic group-hover:scale-125 transition-transform duration-700 block",
                        ...
                        <td className="px-12 py-6 text-center">
                            <div className="flex flex-col items-center gap-3 group-hover:scale-110 transition-transform duration-700">
                                ...
                                <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.5em] font-syne italic">{tx.status}</span>
                            </div>
                        </td>
                      </motion.tr>
                    ))}
