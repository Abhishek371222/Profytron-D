...
| --- | --- | ---: | --- |
| P0 | Launch blockers (Missing / no JWT) | 0 | Fix reachability before claiming launch-ready |
| P1 | Policy-blocked live flows | 3 | Manual/live QA outside harness; do not enable in measure scripts |
| P2 | Partial UI signals | 3 | Tighten expectations or polish |
| P3 | Polish | 0 | Deferred |

| ID | Sev | Finding | Suggested Phase 2 |
| --- | --- | --- | --- |
| PROD-P2-auth-logout | P2 | Step auth/logout Partial: /dashboard | Tighten expect selectors or complete UI signal |
