...
export default function StrategyQueue() {
 ...
 {/* Hover Tooltip */}
 <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 bg-slate-800 border border-slate-700 p-2 rounded shadow-xl text-slate-300 text-xs font-normal z-20 opacity-0 pointer-events-none group-hover/tooltip:opacity-100 transition-opacity">
 {strat.aiBiasDetail}
 </div>
 </div>
 )}
