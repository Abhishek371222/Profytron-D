...
function AdminAuthGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SceneProvider>
      <div data-density={density} className="relative flex h-[100dvh] min-w-0 overflow-hidden bg-background font-sans text-foreground">
        <AmbientDepthBackground variant="admin" position="fixed" />
        {isMobile && mobileOpen && (
          <button
            type="button"
