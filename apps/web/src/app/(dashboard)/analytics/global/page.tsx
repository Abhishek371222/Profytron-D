    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Card className="p-4 bg-gradient-to-br from-cyan-500/15 to-cyan-500/5 border-cyan-300/25">
          ...
          <p className="text-xl font-semibold text-white mt-1">{global?.marketRegime?.label ?? 'Unavailable'}</p>
        </Card>
        ...
        <Card className="p-4 bg-gradient-to-br from-emerald-500/15 to-emerald-500/5 border-emerald-300/25">
          ...
          <p className="text-xl font-semibold text-white mt-1">{global?.macroEvents?.length ?? 0}</p>
        </Card>
      </div>
      ...
      <Card className="p-4 bg-black/40 border-white/10">
        ...
        <div className="space-y-2">
          ...
          {!(leaderboard?.rows?.length) ? (
            <p className="text-xs text-white/60">No leaderboard entries are available yet.</p>
          ) : null}
        </div>
      </Card>
    </div>
