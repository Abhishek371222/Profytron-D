    ...
    <div className="flex-1 min-h-screen bg-[#030303] text-white p-8 space-y-10 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-6">
            <div className="h-20 w-20 rounded-3xl bg-white/[0.03] border border-white/10 flex items-center justify-center shadow-inner relative group overflow-hidden">
               <div className="absolute inset-0 bg-gradient-to-br from-p/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" className="h-14 w-14 rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 relative z-10">
        ...
        <div className="xl:col-span-8 space-y-10">
          ...
          {/* Core Charting Area */}
          <div className="p-8 rounded-[32px] bg-black/40 border border-white/10 backdrop-blur-3xl shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-p/50 to-transparent" />
          ...
          <div className="space-y-6">
            ...
            <div className="min-h-[300px] p-8 rounded-[32px] bg-black/20 border border-white/5">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                       {Object.entries(strategy.monthlyReturns || {}).slice(0, 6).map(([month, val]) => (
                         <div key={month} className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.02] border border-white/5">
        ...
        <div className="xl:col-span-4 space-y-10">
          ...
          <div className="p-8 rounded-[40px] bg-gradient-to-br from-white/[0.05] to-transparent border border-white/10 relative overflow-hidden group">
            ...
            <Button variant="ghost" className="w-full h-12 rounded-xl border border-white/5 bg-white/[0.01] hover:bg-white/[0.05] text-[10px] font-bold uppercase tracking-[0.2em]">Contact Node Admin</Button>
          </div>

          {/* Operational Risk Insight */}
          <div className="p-8 rounded-[40px] bg-rose-500/[0.02] border border-rose-500/10 space-y-6">
          ...
          <div className="p-1 px-8 py-8 rounded-[40px] border border-white/5 bg-black/60 relative overflow-hidden group">
             <div className="flex flex-col items-center text-center space-y-6">
                <div className="h-20 w-20 rounded-full bg-white/[0.02] border border-white/5 flex items-center justify-center relative shadow-[inset_0_0_20px_rgba(255,255,255,0.02)]">
...
function MetricLine({ label, value }: { label: string, value: string }) {
  return (
    <div className="flex items-center justify-between pb-4 border-b border-white/[0.03] last:border-0 last:pb-0">
      <span className="text-[10px] font-bold text-white/30 uppercase tracking-[0.2em]">{label}</span>
