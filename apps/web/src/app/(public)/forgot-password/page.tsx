...
export default function ForgotPasswordPage() {
 ...
 <span className="text-foreground/40 group-hover:text-foreground font-bold tracking-widest text-xs uppercase hidden sm:block">Back to Terminal</span>
 </Link>
 </Magnetic>
 </div>
 ...
 <Link href="/login" className="text-foreground/40 font-bold hover:text-primary transition-colors flex items-center justify-center gap-2">
