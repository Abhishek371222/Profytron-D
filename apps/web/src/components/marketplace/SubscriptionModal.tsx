...
"w-2 h-2 rounded-full transition-all duration-500",
 ...
 <span className="text-xs font-semibold text-white/20 uppercase tracking-[0.2em]">Step {step} of 3</span>
...
"relative p-6 rounded-3xl border transition-all duration-500 flex flex-col gap-3 text-left",
 ...
 >
 {plan.badge && (
 <div className="absolute -top-3 left-6 px-3 py-1 rounded-full bg-emerald-500 text-white text-xs font-semibold uppercase tracking-widest">
 {plan.badge}
 </div>
 )}
 <span className={cn(
"text-xs font-semibold uppercase tracking-widest",
 ...
 <span className="text-xs font-bold text-white/20">{plan.period}</span>
 </div>
 ...
 <label className="text-xs font-semibold text-white/30 uppercase tracking-widest">Selected Plan</label>
 ...
 <label className="text-xs font-semibold text-white/30 uppercase tracking-widest">Payment Method</label>
 ...
 <button className="flex-1 p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center gap-3 font-semibold text-xs uppercase tracking-widest hover:bg-white/10 transition-colors">
 ...
 <span className="text-xs font-semibold text-white uppercase tracking-widest">Total Amount</span>
 ...
 <div className="space-y-2">
 <h2 className="text-3xl font-bold text-white">Subscription Active!</h2>
 ...
 <span className="text-xs font-semibold text-p uppercase tracking-widest">Next Billing Date: May 09, 2026</span>
 </div>
 </motion.div>
 )}
 </div>
 ...
 className="text-xs font-semibold text-white/30 hover:text-white uppercase tracking-[0.2em] transition-colors"
 >
 {step === 1 ? 'Cancel' : 'Back'}
 </button>
 <Button 
 onClick={() => setStep(step + 1)}
 className="h-12 px-10 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs uppercase tracking-[0.2em] shadow-2xl shadow-indigo-600/20 active:scale-95 transition-all"
 >
