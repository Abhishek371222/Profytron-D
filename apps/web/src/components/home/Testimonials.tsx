...
function MarqueeRow({ items, direction = 1, speed = 45 }: { items: typeof testimonials; direction?: 1 | -1; speed?: number }) {
  ...
  return (
    <div className="overflow-hidden relative group/marquee" aria-hidden="true">
      <motion.div
        className="flex"
        animate={{
...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-28 relative overflow-hidden bg-[#030303] border-t border-white/[0.04]">
      ...
      {/* Marquee rows — aria-hidden because content is decorative scrolling.
          Static testimonial content is accessible via the heading above. */}
