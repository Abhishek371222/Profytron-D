...
const plans = [
  ...
  },
  {
    ...
    description:
      "Colocated bare metal for maximum throughput and minimum latency.",
    features: [
...
export function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="py-16 lg:py-32 relative overflow-hidden bg-black selection:bg-p/30"
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
        <div className="text-center mb-10 lg:mb-24">
          <FadeUp>
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 tracking-tight text-white m-0">
              Pricing that{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan, i) => (
            ...
            >
              <div
                className={cn(
                  "relative p-5 sm:p-6 md:p-8 rounded-3xl transition-all duration-500 flex flex-col w-full overflow-hidden backdrop-blur-sm",
                  plan.recommended
              ...
              >
                ...
                <div className="space-y-3 py-4 sm:py-8 flex-grow relative z-10">
