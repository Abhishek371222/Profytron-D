      ...
      <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 lg:gap-24 mb-12 lg:mb-24">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-white/40 text-sm mb-8 leading-relaxed max-w-sm font-medium">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-10 h-10 rounded-full bg-white/2 border border-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400/70 focus-visible:rounded-full"
                >
        ...
        <div className="mt-8 pt-8 border-t border-white/5 text-center w-full">
          <p className="text-[10px] text-white/35 leading-relaxed font-mono max-w-4xl mx-auto uppercase tracking-wide">
