...
export function FeaturesSection() {
 ...
 <div className="max-w-4xl mb-32">
        <FadeUp>
          <div className="inline-flex items-center gap-4 px-5 py-2.5 rounded-2xl bg-white/[0.03] border border-white/10 text-p text-[10px] font-bold uppercase tracking-[0.5em] mb-10 shadow-inner">
            <Cpu className="w-4 h-4 animate-pulse" />
            <span>Industrial_Protocol_v4.20_Stable</span>
          </div>
 ...
 <p className="text-white/40 text-2xl max-w-2xl leading-relaxed font-medium tracking-tight">
 ...
 <h3 className="text-5xl font-semibold text-white mb-6 uppercase tracking-tight">Precision Execution</h3>
 <p className="text-xl text-white/40 max-w-xl font-medium tracking-tight leading-relaxed">
 ...
 <span className="text-xs font-semibold uppercase tracking-[0.4em] text-white/40 group-hover/link:text-p transition-colors">Deploy_Interface</span>
 ...
 <h3 className="text-4xl font-semibold text-white mb-6 uppercase tracking-tight leading-tight">Neural <br />Signal Core</h3>
 ...
 <Link href="/analytics" className="relative z-10 text-xs font-semibold uppercase tracking-[0.4em] text-white/30 group-hover:text-p transition-colors">
 Access_Pulse
 </Link>
 </motion.div>
 </Tilt>
 ...
 <h3 className="text-3xl font-semibold text-white mb-4 uppercase tracking-tight">Sentinel Risk</h3>
 <p className="text-base text-white/40 font-medium tracking-tight leading-relaxed">
 ...
 <h3 className="text-5xl font-semibold text-white uppercase tracking-tight">IDE Strategy Lab</h3>
 <p className="text-xl text-white/40 font-medium tracking-tight leading-relaxed max-w-lg">
 ...
 <Link href="/strategies/builder" className="h-14 px-8 bg-p hover:bg-indigo-500 rounded-2xl flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.3em] text-white transition-all shadow-xl shadow-p/20 group-hover:shadow-p/40">
 Open_Assembler
 <ArrowRight className="w-4 h-4" />
 </Link>
 <span className="text-xs text-white/20 font-semibold tracking-widest uppercase">v0.9.4 Beta_Preview</span>
 </div>
 </motion.div>
 </Tilt>
 </div>
