...
"transition-all duration-500 flex z-40",
 ...
 <main
 className="flex-1 min-w-0 relative h-screen overflow-hidden transition-all duration-300 z-20 w-full"
 >
 {/* TopBar — absolutely pinned to top, never affected by content layout */}
 <div
 className={cn(
"absolute inset-x-0 top-0 z-30 transition-all duration-500",
 mounted && isBuilder
 ...
 {/* Scroll area — starts below the TopBar */}
 <div
 className={cn(
"absolute inset-x-0 bottom-0 overflow-y-auto overflow-x-hidden custom-scrollbar",
 mounted && isBuilder ?"top-0 p-0" :"top-16 sm:top-[68px]"
 )}
 >
 <motion.div
 key={pathname}
 ...
 :"p-[var(--dashboard-p)] pb-24 lg:pb-12 max-w-[1800px] mx-auto w-full min-w-0 flex-col flex min-h-full"
 }
 >
 {children}
 </motion.div>
