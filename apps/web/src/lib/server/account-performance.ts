...
export function resolveDepositBase(input: {
...
}): { depositBase: number; shouldRepairBaseline: boolean; repairedBaseline?: number } {
  ...
  if (netDeposits > 1) {
    ...
    return {
      ...
      repairedBaseline:
        looksCorrupted || isUnsetBaseline(dbInitialEquity) ? netDeposits : undefined,
    };
  }
  ...
  return {
    ...
    repairedBaseline: isUnsetBaseline(dbInitialEquity) ? reconstructed : undefined,
  };
}
