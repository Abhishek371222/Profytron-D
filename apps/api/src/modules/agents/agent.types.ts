...
export const EVENT_TO_AGENTS: Record<string, AgentType[]> = {
  ...
  [AGENT_EVENTS.TRIAL_STARTED]: [AgentType.CUSTOMER_SUCCESS],
  [AGENT_EVENTS.TRIAL_ENDING_SOON]: [AgentType.CUSTOMER_SUCCESS],
...
export const EVENT_LABELS: Record<string, string> = {
  ...
  [AGENT_EVENTS.TRIAL_STARTED]: 'Trial started',
  [AGENT_EVENTS.TRIAL_ENDING_SOON]: 'Trial ending soon',
