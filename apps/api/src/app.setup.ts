...
export function configureApp(app: INestApplication) {
  ...
  // ─── Swagger (API docs) ───────────────────────────────────────────────────
  // SECURITY NOTE: In production these docs should be either disabled entirely
  // or placed behind IP allowlisting / basic auth. They currently expose all
  // endpoint signatures to anyone who can reach the API.
