-- Expands AccountSnapshot with every MetaAPI data category (positions,
-- pending orders, deals, order history, symbols, market data, status,
-- copy trading, performance, risk, events) plus a fast latest-snapshot
-- pointer table. Purely additive: new nullable/defaulted columns on the
-- existing AccountSnapshot table, and brand-new tables — no existing data
-- or queries are affected.
...
DO $$ BEGIN
  ALTER TABLE "AccountLatestSnapshot"
    ADD CONSTRAINT "AccountLatestSnapshot_brokerAccountId_fkey"
    FOREIGN KEY ("brokerAccountId") REFERENCES "BrokerAccount"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
DO $$ BEGIN
  ALTER TABLE "AccountLatestSnapshot"
    ADD CONSTRAINT "AccountLatestSnapshot_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotPosition"
    ADD CONSTRAINT "AccountSnapshotPosition_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotPendingOrder"
    ADD CONSTRAINT "AccountSnapshotPendingOrder_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotDeal"
    ADD CONSTRAINT "AccountSnapshotDeal_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotOrderHistory"
    ADD CONSTRAINT "AccountSnapshotOrderHistory_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotSymbol"
    ADD CONSTRAINT "AccountSnapshotSymbol_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
CREATE INDEX IF NOT EXISTS "AccountSnapshotMarketData_brokerAccountId_symbol_tick_idx" ON "AccountSnapshotMarketData"("brokerAccountId", "symbol", "tickTimestamp");
CREATE INDEX IF NOT EXISTS "AccountSnapshotMarketData_snapshotId_idx" ON "AccountSnapshotMarketData"("snapshotId");
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotMarketData"
    ADD CONSTRAINT "AccountSnapshotMarketData_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotStatus"
    ADD CONSTRAINT "AccountSnapshotStatus_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotCopyTrading"
    ADD CONSTRAINT "AccountSnapshotCopyTrading_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotPerformance"
    ADD CONSTRAINT "AccountSnapshotPerformance_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotRisk"
    ADD CONSTRAINT "AccountSnapshotRisk_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
  ALTER TABLE "AccountSnapshotEvent"
    ADD CONSTRAINT "AccountSnapshotEvent_snapshotId_fkey"
    FOREIGN KEY ("snapshotId") REFERENCES "AccountSnapshot"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN null; END $$;
